...
export class VWActorFactory {
    public static createVWActorFromJSONObject(data: any): VWActor {
    ...
    public static createVWCleaningAgentFromJSONObject(data: any): VWCleaningAgent {
        if (data === null || data === undefined) {
    ...
    public static createVWUserFromJSONObject(data: any): VWUser {
        if (data === null || data === undefined) {
