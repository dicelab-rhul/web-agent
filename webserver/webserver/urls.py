...
urlpatterns: list[URLResolver] = [path(p, include("webserver.web_agent_server.urls")) for p in RELEVANT_PATHS] + [re_path(p, include("webserver.web_agent_server.urls")) for p in RELEVANT_RE_PATHS]
