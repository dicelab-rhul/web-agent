...
export class VWCell implements VWDiv {
    ...
    private getCellImageSrc(): string {
        if (!VWExistenceChecker.allArgumentsExist(this.locationAppearance)) {
            ...
            return `/${envData["vacuumworld-ts"]}/res/images/locations/empty.png`;
        }
    }
    ...
    private getCellImageSrcIfActorIsPresent(): string {
        ...
        return `/${envData["vacuumworld-ts"]}/res/images/locations/${debugPath}actor/${colour}_${orientation}.png`;
    }
    ...
    private getCellImageSrcIfDirtIsPresent(): string {
        ...
        return `/${envData["vacuumworld-ts"]}/res/images/locations/${debugPath}dirt/${colour}_dirt.png`;
    }
